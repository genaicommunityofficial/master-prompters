...
insert into public.pc_questions (id, competition_id, question_number, title, description, input_type, max_length, min_length, display_order, evaluation_config) values
  ('q1', 'competition_2026', 1, 'Meme Generation',
    'Write a prompt that would produce an original, shareable meme. Name the joke, the visual setup or template, the on-screen text, the tone, and the audience. It should read instantly on a phone and stay funny on a second look.', 'textarea', 2000, 20, 1, '{}'::jsonb),
  ('q2', 'competition_2026', 2, 'AI Visual Art Creation',
    'Direct an image model as if you were briefing an illustrator. Specify subject, composition, lighting, palette, medium, and mood in enough detail that two people would picture the same artwork.', 'textarea', 2000, 20, 2, '{}'::jsonb),
  ('q3', 'competition_2026', 3, 'AI Digital Storytelling / Creative Writing',
    'Write a prompt for a short story or scene. Include character, setting, conflict, narrative voice, and how it should end. Name the genre, approximate length, and any language or point-of-view constraints.', 'textarea', 2000, 20, 3, '{}'::jsonb),
  ('q4', 'competition_2026', 4, 'AI Song Factory',
    'Write a prompt for an original song. Specify genre, mood or tempo, song structure (verse, chorus, bridge), vocal character, and the feeling the track should leave. Include a line of lyric direction if it helps.', 'textarea', 2000, 20, 4, '{}'::jsonb),
  ('q5', 'competition_2026', 5, 'AI-Generated Poetry in Local Languages',
    'Write a prompt for a poem in an Indian or regional language you name clearly. Specify the form (free verse, ghazal, haiku, and so on), the central images, and what the poem should mean.', 'textarea', 2000, 20, 5, '{}'::jsonb),
